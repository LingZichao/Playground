...
HD_PWD='C:/Users/lingz/Desktop/Verilog/termist/vivado/project_mips.runs/clk_sys2ddr3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_sys2ddr3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_sys2ddr3.tcl
