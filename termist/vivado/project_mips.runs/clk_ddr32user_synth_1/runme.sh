...
HD_PWD='C:/Users/lingz/Desktop/Verilog/termist/vivado/project_mips.runs/clk_ddr32user_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_ddr32user.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_ddr32user.tcl
