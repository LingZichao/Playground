...
#
# Generated by export_simulation on Wed Sep 07 00:01:02 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './clk_ddr32user.sh' script.

./clk_ddr32user.sh -reset_run
...
./clk_ddr32user.sh -noclean_files

For more information on the script, please type './clk_ddr32user.sh -help'.
