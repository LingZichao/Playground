...
#
# Generated by export_simulation on Wed Sep 07 01:06:04 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './clk_sys2ddr3.sh' script.

./clk_sys2ddr3.sh -reset_run
...
./clk_sys2ddr3.sh -noclean_files

For more information on the script, please type './clk_sys2ddr3.sh -help'.
